...
if __name__ == "__main__":
    preprocess_data(input_path="data/raw/home_credit_raw.csv", train_output="data/processed/train.csv", test_output="data/processed/test.csv", scaler_output="models/scaler.pkl")
